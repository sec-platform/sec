...
import type { UpgradeDigest } from '../semantics/upgrade/upgrade-artifact.ts';
...
type UpgradePlanningUseCaseInput = Readonly<{
  blockId: string;
...
type UpgradeApplyPlanningFailureContext = Readonly<{
  blockId: string;
  targetVersion: string;
  workspaceIdentityDigest: string;
  planningRequestRevision: UpgradeDigest;
...
async function planWorkspaceUpgrade(
