...
export const VERIFICATION_LANE_CHOICES = Object.freeze([...VERIFICATION_LANES]) as readonly VerificationLane[];
export const VERIFICATION_LANE_CHOICES_DESCRIPTION = VERIFICATION_LANE_CHOICES.map((lane, index) =>
