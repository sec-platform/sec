...
export const REVIEW_STABILITY_POLICY_SCHEMA = 'sec-review-stability-policy-v1' as const;
export const REVIEW_STABILITY_RECEIPT_SCHEMA = 'sec-review-stability-receipt-v1' as const;
...
export const REVIEW_OBSERVER_PRODUCER_IDENTITY =
  'src/verification/ci/runtime/verification-session-github.ts' as const;
