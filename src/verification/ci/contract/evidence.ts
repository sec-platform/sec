...
import { CI_GITHUB_ACTIONS_IDENTITY_POLICY, CI_VERIFICATION_ACTION_ARTIFACT_SCHEMA } from '../../action/contract/provider.ts';
...
import { VERIFICATION_ACTION_PROVIDER_TERMINAL_ARTIFACT_FILE, verificationActionProviderTerminalArtifactName, type VerificationActionProviderOrigin } from '../../action/contract/provider.ts';
