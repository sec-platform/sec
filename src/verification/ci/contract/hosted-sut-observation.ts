...
export type CodexDevelopmentHostedSutEnvironmentProjection = readonly Readonly<{
  name: string;
  valueDigest: VerificationActionKeyDigest;
}>[];

export type CodexDevelopmentHostedSutPhysicalCommandAuthorization = Readonly<{
...
export type CodexDevelopmentHostedSutSandboxCapabilityObservation = Readonly<{
...
export type CodexDevelopmentHostedSutPhysicalCommandObservation = Readonly<{
...
export type CodexDevelopmentHostedSutDerivedCleanup = Readonly<{
