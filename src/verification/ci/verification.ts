...
export const CodexDevelopmentTrustedBootstrapSutHarness = [
  ...
  '  await execute("repository-audit", ["bun", "src/brownfield/repository-audit/cli.ts", "--json"]);',
