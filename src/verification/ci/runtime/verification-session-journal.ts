...
export const VERIFICATION_SESSION_JOURNAL_EVENT_SCHEMA =
  'sec-verification-session-journal-event-v1' as const;
export const VERIFICATION_SESSION_OPERATION_CLAIM_SCHEMA =
...
export function parseVerificationSessionOperationClaim(source: string): VerificationSessionOperationClaim {
