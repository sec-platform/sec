...
import { CI_VERIFICATION_CONTRACT_REVISION, CodexDevelopmentBuildVerificationPlan } from '../index.ts';
import {
...
} from '../../../control/integration/authorization.ts';
import {
  SEC_INTEGRATION_PLATFORM_POLICY_DIGEST
} from '../../../control/integration/platform-policy.ts';
import {
...
import { createVerificationSessionProposalDigest, createVerificationSessionRevision, createVerificationSession, parseVerificationSession, type VerificationSessionInput, type VerificationSession } from '../../session/contract/session.ts';
import {
...
export const SEC_EVIDENCE_REQUIREMENT_DIGEST = hash(Object.freeze({
  schema: 'sec-verification-evidence-requirement-v4', terminalStatus: 'passed', exactActionClosure: true
}));
export const SEC_SCOPE_ISSUER_IDENTITY = 'src/verification/ci/runtime/verification-session.ts@scope-issuer-v1' as const;
 ...
 */
export function createVerificationSessionActionDependencyRequiredBlobs(
...
export function createVerificationSessionScopeProposalDigest(input: {
