...
export const VERIFICATION_SESSION_REVIEW_LOCATOR_COMMENT_SCHEMA =
...
export const VERIFICATION_SESSION_REVIEW_WAKEUP_COMMENT_SCHEMA =
...
export interface VerificationSessionReviewLocatorComment {
...
export interface VerificationSessionReviewWakeupComment {
