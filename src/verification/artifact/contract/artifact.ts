...
import { buildProductVerificationObservationBindings, buildBlockedProductVerificationClaimSummary, buildExpectedProductVerificationClaimSummary, inferProductVerificationRuntimeMode, PRODUCT_FAST_GATE_ID, PRODUCT_POLICY_GATE_ID, PRODUCT_RUNTIME_GATE_ID, type ProductVerificationObservations } from '../../profile/contract/product.ts';
