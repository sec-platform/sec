...
export const TCB_RUNTIME_ENTRYPOINTS = SEC_TRUSTED_BOOTSTRAP_REGISTRY.runtimeEntrypoints;
...
export const TCB_REVIEWED_PROCESS_DISPATCHERS = new Set([
  ...
  'src/verification/ci/verification.ts::function-declaration:hostedActionGhReadJson::spawnSync#1',
  'src/verification/ci/verification.ts::function-declaration:runHostedMaterializerCommand::spawnSync#1',
  'src/control/agent/agent-operation-activation.ts::function-declaration:command::spawnSync#1',
  'src/control/branch-lifecycle/branch-closeout-receipt.ts::function-declaration:runCloseoutObservationGh::spawnSync#1',
  'src/control/branch-lifecycle/branch-closeout.ts::function-declaration:runCloseoutGit::spawnSync#1',
  'src/control/branch-lifecycle/branch-lifecycle-inventory.ts::function-declaration:runInventoryCommand::spawnSync#1',
  'src/control/branch-lifecycle/branch-recovery.ts::function-declaration:runRecoveryGit::spawnSync#1',
  'src/verification/ci/runtime/ci-orchestration-core.ts::function-declaration:CodexDevelopmentDefaultChangedPaths::spawnSync#1',
  'src/verification/ci/runtime/ci-orchestration-core.ts::function-declaration:CodexDevelopmentDefaultGitRevision::spawnSync#1',
  'src/verification/ci/runtime/ci-orchestration-core.ts::function-declaration:CodexDevelopmentDefaultTrackedTreeIsClean::spawnSync#1',
  'src/verification/ci/runtime/ci-orchestration-core.ts::function-declaration:CodexDevelopmentRunGateProcess::spawn#1',
...
export const TCB_REVIEWED_NETWORK_DISPATCHERS = new Set([
  'src/control/integration/integration-authorization-status-github.ts::function-declaration:dispatchGitHubApiRequest::globalThis.fetch#1'
]);
...
export function deriveTcbClosureTrustRevision(
...
export const TCB_CLOSURE_ACTION_RESULT_SCHEMA =
  'sec-tcb-closure-action-result-v1' as const;
export const TCB_CLOSURE_ACTION_PRODUCER_REVISION =
...
export function createTcbClosureActionPlan(input: Readonly<{
  ...
  const action = createVerificationActionKey({
    ...
    producer: {
      identity: 'src/verification/trust/runtime/closure-lock.ts',
