...
export const CI_VERIFICATION_ACTION_PROPOSAL_SCHEMA =
  'sec-verification-action-proposal-v2' as const;
export const CI_VERIFICATION_ACTION_PARENT_DISPATCH_PROPOSAL_SET_SCHEMA =
  'sec-verification-action-parent-dispatch-proposal-set-v2' as const;
export const CI_VERIFICATION_ACTION_PARENT_DISPATCH_PLAN_SCHEMA =
  'sec-verification-action-parent-dispatch-plan-v2' as const;
export const CI_VERIFICATION_ACTION_PROVIDER_ENVELOPE_SCHEMA =
...
export const CI_VERIFICATION_ACTION_PARENT_DISPATCH_PLAN_ARTIFACT_PREFIX =
  CI_VERIFICATION_ACTION_PARENT_DISPATCH_PLAN_SCHEMA;
export const CI_VERIFICATION_ACTION_PARENT_JOB_NAME =
  'coordinate-verification-session' as const;
export const CI_VERIFICATION_ACTION_PARENT_PLAN_STEP_NAME =
...
export const CI_VERIFICATION_ACTION_PRODUCER_REVISION =
  'sec-ci-verification-action-producer-v2' as const;
export const CI_VERIFICATION_ACTION_PLAN_CLOSURE_SCHEMA =
...
export function assertCiVerificationActionProposalMember(
  proposal: CiVerificationActionProposal,
  parentPlan: CiVerificationActionParentDispatchPlan
): void {
...
export function buildCiVerificationActionPlan(options: {
  ...
  const action = createVerificationActionKey({
    ...
    producer: {
      identity: 'src/verification/action/contract/ci.ts',
...
export function resolveCiVerificationDevRunnerTarget(options: {
  ...
  if (plan.action.producer.identity !== 'src/verification/action/contract/ci.ts' ||
