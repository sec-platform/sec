...
export const VERIFICATION_ACTION_PROVIDER_START_MARKER_SCHEMA =
  'sec-verification-action-start-marker-v2' as const;
export const VERIFICATION_ACTION_PROVIDER_TERMINAL_ANCHOR_SCHEMA =
...
export const VERIFICATION_ACTION_PROVIDER_POLICY_DIGEST = digest(
...
export type VerificationActionProviderStatusCreator = Readonly<{
  login: string;
  id: number;
  nodeId: string;
  type: string;
...
export type VerificationActionProviderDecisionDisposition =
  | 'start-allowed'
