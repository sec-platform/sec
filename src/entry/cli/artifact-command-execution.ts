import type { CiArtifactManifestInspectionSource } from '../../application/ci-artifact-manifest-inspect.ts';
...
export interface ArtifactCommandOperations {
  ...
  observeManifest(): Promise<Parameters<typeof buildArtifactUploadPathContract>[0]>;
  generate(): Promise<Parameters<typeof buildArtifactUploadPathContract>[0]>;
}
