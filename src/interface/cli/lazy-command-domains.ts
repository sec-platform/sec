...
const loadManifestParser = memoizedModule(() => import('../../compiler/parse/load-manifest.ts'));
const loadPlanParser = memoizedModule(() => import('../../compiler/parse/load-plan.ts'));
...
export const loadManifestById = lazyFunction(loadManifestParser, 'loadManifestById');
export const loadWorkspacePlan = lazyFunction(loadPlanParser, 'loadWorkspacePlan');
