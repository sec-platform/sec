...
import { AppModeSchema, PackageManagerSchema, PlanInputSchema, PlanRegistrySourceSchema, type PlanRegistrySourceInput } from '../../../compiler/contract/plan-schema.ts';
...
import type { PlanFile, PlanRegistry, PlanRegistrySource } from '../../../compiler/contract.ts';
