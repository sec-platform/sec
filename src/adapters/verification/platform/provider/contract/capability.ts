...
export const VERIFICATION_PROVIDER_CAPABILITY_SCHEMA =
  'sec-verification-provider-capability-v1' as const;
export const VERIFICATION_PROVIDER_AVAILABILITY_EPOCH_SCHEMA =
...
export const VERIFICATION_CAPABILITY_PROVIDER: Readonly<Record<
