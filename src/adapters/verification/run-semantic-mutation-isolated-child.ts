...
import {
  ...
  type SemanticMutationIsolatedSemanticBundleEvidence
...
import {
  ...
  parseSemanticMutationIsolatedProgressTransportBytes,
...
function resolveCanonicalSemanticMutationIsolatedRuntimeInputSources(
...
interface SemanticMutationIsolatedVerificationExecutionRequest {
...
interface SemanticMutationIsolatedVerificationSupervisorResult extends CommandResult {
  readonly progress: SemanticMutationIsolatedProgressReadResult;
}

export type SemanticMutationIsolatedVerificationSupervisor = (
  request: SemanticMutationIsolatedVerificationExecutionRequest
) => Promise<SemanticMutationIsolatedVerificationSupervisorResult>;
...
export function createSemanticMutationIsolatedVerificationSupervisor(options: {
  ...
  return async (request) => {
    ...
    let outcome:
      | Readonly<{ status: 'succeeded'; value: SemanticMutationIsolatedVerificationSupervisorResult }>
    ...
    try {
      ...
      outcome = Object.freeze({
        ...
        value: Object.freeze({
          ...result,
          stdout: '',
          progress: parseSemanticMutationIsolatedProgressTransportBytes(
...
export interface IsolatedVerificationArtifacts {
  ...
  readonly semanticBundle: SemanticMutationIsolatedSemanticBundleEvidence;
...
export async function runSemanticMutationIsolatedVerificationChild(
  ...
  try {
    ...
    await commitFence();
    const semanticBundle = projectSemanticMutationIsolatedSemanticBundle(
