...
export type SemanticMutationIsolatedProcessObservation = Readonly<{
  code: number;
  stdout: Uint8Array;
  stderr: string;
...
export async function runSemanticMutationIsolatedProcess(input: Readonly<{
...
}>): Promise<SemanticMutationIsolatedProcessObservation> {
  ...
  let result: SemanticMutationIsolatedProcessObservation | undefined;
