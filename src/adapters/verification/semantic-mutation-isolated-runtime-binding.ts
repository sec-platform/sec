...
export function registerSemanticMutationIsolatedRuntimePlanBinding(binding: object): void {
 ...
 */
export function forwardSemanticMutationIsolatedRuntimePlanBinding(
  source: unknown,
  target: object
): void {
...
export function resolveSemanticMutationIsolatedRuntimePlanBinding(
  binding: unknown
): object | undefined {
