...
export interface WindowsAppContainerNativeHelperEntryMetadata {
...
export interface WindowsAppContainerNativeHelperBuildOutput {
  readonly arrayBuffer: () => Promise<ArrayBuffer>;
}

export interface WindowsAppContainerNativeHelperBuildResult {
  readonly success: boolean;
  readonly outputs: readonly WindowsAppContainerNativeHelperBuildOutput[];
}

export type WindowsAppContainerNativeHelperBuilder = (
  entryPath: string
