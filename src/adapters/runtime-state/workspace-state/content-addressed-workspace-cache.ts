...
export interface ContentAddressedWorkspaceCacheHint {
...
export type ContentAddressedWorkspaceCachePublication = Readonly<{
  entries: readonly ContentAddressedWorkspaceCacheEntry[];
  predecessorToken: Uint8Array;
}>;

export interface ContentAddressedWorkspaceCacheNamespace {
  open(keyDigest: `sha256:${string}`): ContentAddressedWorkspaceCacheHint;
}

export type ContentAddressedWorkspaceCacheSessionReceipt = Readonly<{
