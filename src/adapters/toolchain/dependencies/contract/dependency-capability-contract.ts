...
type DependencyManifestSection = 'dependencies' | 'devDependencies';
export type GeneratedRuntimeProjection = 'dependency' | 'devDependency' | 'none';

type DependencyFreshnessPolicy = Readonly<
  | {
...
export const DEPENDENCY_CAPABILITY_SPECS: readonly Readonly<DependencyCapabilitySpec>[] = deepFreeze([
  { name: '@awasm/noble', section: 'dependencies', generatedRuntime: 'none' },
...
function dependencyCapabilityNamesForSection(
