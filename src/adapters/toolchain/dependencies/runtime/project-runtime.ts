...
import {
  InstallLockTerminalHandoffObservedError,
  assertCompilerDependencyCoordinationCutover,
  compilerDependencyCoordinationLocatorPath,
  compilerDependencyCoordinationMarkerPath,
  compilerDependencyCoordinationRoot,
  compilerDependencyCoordinationSession,
  consumeInstallLockTerminalHandoffRequest,
  inspectCompilerDependencyCoordinationLayout,
  issueInstallLockTerminalHandoffRequest,
  legacyCompilerDependencyCoordinationRoot,
  publishCompilerDependencyCoordinationLocator,
  readCompilerDependencyCoordinationCutover,
  readCompilerDependencyCoordinationLocator,
  resolveCompilerDependencyCoordinationRoots,
  withDependencyCoordinationLease,
  withInstallLock,
  type CompilerDependencyCoordinationCutover,
  type RuntimeDependencyCapturedFailure
} from './dependency-coordination.ts';
...
import type {
  ...
  CompilerDependencyExecutionRetirementReceipt,
...
} from './project-runtime-contract.ts';
export type {
  CompilerDependencyEnvironmentRetirementReceipt,
  CompilerDependencyExecutionGenerationAuthority,
  CompilerDependencyExecutionRetirementReceipt,
...
async function withCompilerDependencyCoordinationLease<T>(
  ...
  return withDependencyCoordinationLease(
    compilerDependencyRoot,
    options,
    callback,
    {
      beforeOperation: async (session, operationOptions) => {
...
async function migrateCompilerDependencyCoordination(
  ...
  try {
    ...
    consumeInstallLockTerminalHandoffRequest(request);
    const cutover = readCompilerDependencyCoordinationCutover(root);
    publishCompilerDependencyCoordinationLocator({
      compilerDependencyRoot: root,
      cutover,
