...
import { ANONYMOUS_PACKAGE_REGISTRY_PROFILE } from '../../../providers/package-registry/contract/anonymous-registry.ts';
import { queryAnonymousPackageRegistryLatestVersions } from '../../../providers/package-registry/runtime/anonymous-registry.ts';
...
export async function getDependencyFreshness(
  ...
  if (operationFailure !== undefined && retirementFailure !== undefined) {
    throw new AggregateError(
      [operationFailure.error, retirementFailure.error],
