...
export function parseExactCommentRetirement(value: unknown): ExactCommentRetirement {
  ...
  if (!['automation-noise', 'superseded-operator-command', 'superseded-execution-log'].includes(String(input.reason))) {
  ...
  return Object.freeze({
    ...
    reason: input.reason as ExactCommentRetirement['reason']
  });
}
