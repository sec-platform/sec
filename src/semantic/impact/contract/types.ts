import type { FactAssertionUpdateField, FactDelta, FactDeltaEndpointContext } from '../../engineering-ir/contract/delta-types.ts';
import type { SemanticEntityId } from '../../engineering-ir/contract/entity-types.ts';
import type { FactAssertionId, SemanticFactId, SemanticPredicate } from '../../engineering-ir/contract/fact-types.ts';
import type { ENGINEERING_IR_FORMAT_VERSION } from '../../engineering-ir/contract/root-types.ts';
