import { canonicalEquals, compareCodeUnits, deepFreeze } from '../../system-architecture/foundation/runtime/canonical.ts';
import { isCanonicalPortableLogicalPath } from '../../system-architecture/foundation/contract/logical-path.ts';
import { PROVENANCE_FORMAT_VERSION, type ProvenanceArtifact, type ProvenanceFile } from './contract/types.ts';
