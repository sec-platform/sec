...
import {
  ...
  type UpgradeWorkspacePreviewReadOperations
...
const UPGRADE_PLANNING_OPERATIONS: UpgradePlanningUseCaseOperations = Object.freeze<UpgradePlanningUseCaseOperations>({
...
const UPGRADE_PREVIEW_READ_OPERATIONS = Object.freeze<UpgradeWorkspacePreviewReadOperations>({
  loadWorkspacePlan: async workspaceRoot => loadWorkspacePlan(workspaceRoot),
  readLockFile: async workspaceRoot => readLockFile(workspaceRoot)
});
  ...
  return executeUpgradeApplyLifecycle(
    ...
    },
    {
      ...
      terminalReadback: {
        ...
        readWorkspacePlan: async () => loadWorkspacePlan(workspaceRoot)
      },
      terminalPublication: {
        publish: terminal =>
      ...
      retireBackup: async (backup, primaryFailure) => {
