...
import { assertCanonicalVerificationArtifactSet } from '../../assurance/verification/artifact/contract/artifact.ts';
...
import { readReviewGovernanceReports } from '../../adapters/compilation/emit/read-review-governance-reports.ts';
import {
  buildExplainGraph,
  renderExplainGraphDot,
  renderExplainGraphMermaid
} from '../../adapters/compilation/emit/write-explain-graph.ts';
import { buildProvenance } from '../../adapters/compilation/emit/write-provenance.ts';
import {
  buildProvenanceSummary,
  buildReviewSummary,
  buildSemanticViewSummary
} from '../../adapters/compilation/emit/write-review-summary.ts';
import { readLockFile } from "../../adapters/workspace/lock.ts";
import { bindPipelineCompileRequest, type PipelineCompileRequest } from '../../adapters/compilation/pipeline/invocation.ts';
...
import { getPipelineStageDefinition } from '../../adapters/compilation/pipeline/pass-registry.ts';
import { capturePipelineProofRecord, samePipelineSequence } from '../../adapters/compilation/pipeline/proof-data.ts';
