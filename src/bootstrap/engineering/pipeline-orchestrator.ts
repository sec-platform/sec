...
export async function compileWorkspace(
  ...
  return coordinateWorkspaceCompilationAdmission<WorkspaceWriteLeaseToken, CompileWorkspaceResult>({
    ...
    runTransaction: (leaseSignal, workspaceWriteLease) =>
      withPipelineTransaction(
        ...
        async context => completeWorkspaceCompilationTransaction(context.transactionId, stages, {
          ...
          buildCompletionProof: async result => (await buildPipelineCompletionProof(workspaceRoot, {
