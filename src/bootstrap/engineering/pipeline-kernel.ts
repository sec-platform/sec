...
import {
  readLockFile,
  saveLock
} from '../../adapters/workspace/lock.ts';
import { sealPipelineExecutionContext } from '../../adapters/compilation/pipeline/execution-context.ts';
...
} from '../../adapters/compilation/pipeline/journal.ts';
import type {
