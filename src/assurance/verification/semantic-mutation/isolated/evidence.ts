...
export interface IsolatedVerificationEvidenceArtifacts {
  readonly rawDigests: {
...
type SemanticMutationIsolatedVerificationFailureEvidence = Readonly<{
  readonly stage: string;
}>;

export type IsolatedVerificationEvidence =
  | Readonly<{
      readonly status: 'passed';
      readonly artifacts: IsolatedVerificationEvidenceArtifacts;
    }>
  | Readonly<{
...
export function isolatedVerificationEvidenceDigest(
