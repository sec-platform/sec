...
import { deepFreeze, rawSha256 } from '../../system-architecture/foundation/runtime/canonical.ts';
import { CodexDevelopmentCreateTestImpactTransitionObservation, gitPathBlobBatchArgs, gitChangedFileDiffArgs, gitUntrackedFileArgs, gitWorkingTreeStatusArgs, parseGitChangedRecordsOutput, parseGitPathBlobBatchOutput, parseGitUntrackedFileOutput, type CodexDevelopmentTestImpactTransitionObservation } from '../../verification/test-impact/runtime/transition.ts';
...
import { createAuthorityGitReadSession, type GitReadProviderResolutionFailure, type GitReadSessionCommand, type GitReadProviderIdentity, type GitReadProviderRoute, type GitReadSession, type GitExecutableIdentity } from '../../external-capabilities/git-read/runtime/session.ts';
import {
...
import { FAST_TEST_PROCESS_POLICY_TEST_FILE, TEST_ARCHITECTURE_POLICY_TEST_FILE, getFastTestFilesSync, getSlowTestFilesSync, isFastTestFile, isTestFile, isKnownSlowTestSuiteId, isSlowTestFile, slowTestSuiteFiles, slowTestSuiteIds } from '../../verification/test-impact/contract/budget.ts';
