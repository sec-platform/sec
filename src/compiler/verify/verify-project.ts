...
import { canonicalEquals, sha256 } from '../../system-architecture/foundation/runtime/canonical.ts';
...
import { buildProductVerificationObservationBindings, buildExpectedProductVerificationClaimSummary, type ProductVerificationGateObservation, type ProductVerificationObservations } from '../../verification/profile/contract/product.ts';
