import { type SemanticEntity, type SemanticEntityKind } from '../../semantic/engineering-ir/contract/entity-types.ts';
import { SEMANTIC_PREDICATES, type SemanticFact, type SemanticValue } from '../../semantic/engineering-ir/contract/fact-types.ts';
import { type PredicateSignatureRegistry, type PredicateSignatureVariant, type PredicateValueSchema } from '../../semantic/engineering-ir/contract/predicate-signature-types.ts';
