...
export const SEMANTIC_MUTATION_ISOLATED_BOOTSTRAP_RELATIVE_PATH =
  '.isolated-compiler/src/compiler/orchestration/semantic-mutation-isolated-verification-bootstrap.mjs' as const;
export const SEMANTIC_MUTATION_ISOLATED_STAGED_LOADER_RELATIVE_PATH =
  '.isolated-compiler/src/compiler/orchestration/semantic-mutation-isolated-verification-loader.mjs' as const;
