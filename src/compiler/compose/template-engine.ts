...
import { renderTemplateString, TEMPLATE_MAX_INPUT_BYTES } from './render-template-string.ts';

export type { TemplateContext, TemplateContextValue } from './render-template-string.ts';
