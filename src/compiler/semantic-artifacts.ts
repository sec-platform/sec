...
export const SEMANTIC_ARTIFACT_SET_IDENTITY_DOMAIN =
  'semantic-artifact-set' as const;
export const SEMANTIC_ARTIFACT_SET_IDENTITY_SCHEMA = 'v1' as const;

export type SemanticArtifactSetIdentity = Identity<
