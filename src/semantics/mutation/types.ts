...
import type { FactDelta, FactDeltaEndpointContext } from '../engineering-ir/delta-types.ts';
import type { SemanticEntityId, SemanticEntityKind } from '../engineering-ir/entity-types.ts';
import type { FactAssertionId, SemanticFactObject, SemanticPredicate } from '../engineering-ir/fact-types.ts';
import type { SemanticImpactPropagation } from '../impact/types.ts';
...
type SemanticMutationContractVersion = typeof SEMANTIC_MUTATION_CONTRACT_VERSION;
type SemanticMutationOperationRegistryRevision =
  typeof SEMANTIC_MUTATION_OPERATION_REGISTRY_REVISION;
type SemanticMutationExpectationRevision =
  typeof SEMANTIC_MUTATION_EXPECTATION_REVISION;
type SemanticMutationVerificationPolicyRevision =
  typeof SEMANTIC_MUTATION_VERIFICATION_POLICY_REVISION;
type SemanticMutationSourceAdapterRegistryRevision =
  typeof SEMANTIC_MUTATION_SOURCE_ADAPTER_REGISTRY_REVISION;
type SemanticContractYamlAdapterId = typeof SEMANTIC_CONTRACT_YAML_ADAPTER_ID;
type SemanticContractYamlAdapterRevision = typeof SEMANTIC_CONTRACT_YAML_ADAPTER_REVISION;
type SemanticMutationSourcePathEvidenceRevision =
  typeof SEMANTIC_MUTATION_SOURCE_PATH_EVIDENCE_REVISION;
type SemanticMutationSourceEditPlanRevision =
  typeof SEMANTIC_MUTATION_SOURCE_EDIT_PLAN_REVISION;
type SemanticMutationRollbackManifestRevision =
...
interface ExpectedFactAssertion {
  readonly assertionId: FactAssertionId;
...
type SemanticMutationPreparationRejectedAt =
  | 'source-resolution'
  | 'path'
  | 'transform'
  | 'cas'
...
type SemanticMutationPreparation =
  | {
...
interface SemanticMutationPlanBase {
  readonly contractVersion: SemanticMutationContractVersion;
  readonly requestId: string;
  readonly requestRevision: string;
  readonly authorizationRevision: string;
...
type SemanticMutationEarlyRejectionStage =
  | 'base'
  | 'precondition'
...
interface SemanticMutationResultBase {
  readonly contractVersion: SemanticMutationContractVersion;
  readonly requestId: string;
  readonly requestRevision: string;
  readonly planRevision: string;
