...
import type { FactProvenanceKind, SemanticAuthority, SemanticPredicate, SemanticValue } from '../engineering-ir/fact-types.ts';
...
type ViewRelation = SemanticPredicate;
type ViewReferenceKind = (typeof VIEW_REFERENCE_KINDS)[number];
