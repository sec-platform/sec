...
function isUpgradeDigest(value: unknown): value is UpgradeDigest {
...
export const UpgradeExecutionTerminalSchema = z.object({
...
export const UpgradeDiagnosticsSchema = z.discriminatedUnion('phase', [
...
export function validateUpgradeExecutionTerminal(value: unknown): UpgradeExecutionTerminal {
...
export function upgradeExecutionTerminalDigest(value: unknown): UpgradeDigest {
  return validateUpgradeExecutionTerminal(value).terminalRevision;
}
