...
export const SEC_WINDOWS_CONTROL_CLI_ENVIRONMENT_SPEC_PATH =
  'src/external-capabilities/windows-control-cli/profile/sec-windows-control-cli-v1.json' as const;
...
export const SEC_WINDOWS_CONTROL_CLI_ROOT_CLOSURE_STATUS =
...
export const SEC_WINDOWS_CONTROL_CLI_ROOT_CLOSURE_RECEIPT_SCHEMA =
  'sec-windows-control-cli-installed-adoption-receipt-v1' as const;

export type WindowsControlCliExecutableRole = 'launcher' | 'effective';
export type WindowsControlCliExecutableEntryAuthority = {
  roles: WindowsControlCliExecutableRole[];
  relativePath: string;
  observedSizeBytes: number;
  observedSha256: string;
};
export type WindowsControlCliModuleEntryAuthority = {
  relativePath: string;
  observedSizeBytes: number;
  observedSha256: string;
};
...
export type WindowsControlCliPositiveReceiptContract = DeepReadonly<
