...
export const SEC_OPERATION_READ_PLAN_SCHEMA = 'sec-operation-read-plan-v2' as const;
export const SEC_OPERATION_READ_PLAN_REVISION = 'operation-read-plan-compiler-v2' as const;
...
export interface SecOperationReadReference {
  readonly id: string;
  readonly ref: string;
...
export interface SecOperationReadFrontier {
  readonly id: string;
  readonly reasonCode: string;
  readonly allowedRefIds: readonly string[];
}

export interface SecOperationReadReceipt {
...
export interface SecOperationInvalidationInput {
  readonly id: string;
  readonly revision: string;
}
