...
export const SEC_ROADMAP_WORK_CATALOG_SCHEMA =
  'sec-roadmap-work-catalog-v1' as const;
export const SEC_WORK_DECISION_RECEIPT_SCHEMA =
  'sec-work-decision-receipt-v1' as const;
export const SEC_WORK_ROLLING_PROJECTION_SCHEMA =
...
export type SecRoadmapCatalogDisposition = 'active' | 'deferred' | 'superseded';
...
export interface SecWorkRegistryEntryObservation {
...
export interface SecWorkRollingProjectionItem {
  readonly packageId: string;
  readonly workId: string;
  readonly tracking: string;
  readonly currentSpecRef: string;
