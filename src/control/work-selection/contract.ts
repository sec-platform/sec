...
export interface SecWorkSelectionIdentity {
...
export interface SecWorkCandidateDecision {
  readonly workId: string;
  readonly candidateRef: string;
  readonly currentSpecRef: string;
  readonly currentSpecRevision: SecWorkDigest;
...
export interface SecWorkSelectionPrecondition {
  readonly workId: string;
...
export interface SecWorkCurrentSpecBinding {
  readonly workId: string;
  readonly currentSpecRef: string;
  readonly currentSpecRevision: SecWorkDigest;
}
