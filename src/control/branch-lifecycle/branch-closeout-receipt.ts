...
export const BRANCH_CLOSEOUT_ENFORCEMENT_MARKER_PATH =
  'src/control/branch-lifecycle/branch-closeout-receipt.ts' as const;
export const BRANCH_CLOSEOUT_RECEIPT_COMMENT_MARKER =
  '<!-- sec-branch-closeout-receipt-v1 -->' as const;
export const BRANCH_CLOSEOUT_OPERATION_PUBLICATION_SCHEMA =
...
export const BRANCH_CLOSEOUT_EFFECT_START_PUBLICATION_SCHEMA =
...
export const HOSTED_WORKFLOW_COMMENT_PROVENANCE_SCHEMA =
...
export function parseBranchCloseoutEffectStartPublication(
  value: unknown
): BranchCloseoutEffectStartPublication {
...
export function parseBranchCloseoutOperationPublication(
  value: unknown
): BranchCloseoutOperationPublication {
