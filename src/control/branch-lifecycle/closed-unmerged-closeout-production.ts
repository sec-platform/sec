...
import { deleteExactGitRef } from '../../external-capabilities/git/ref-effect.ts';
import {
...
import { bindSecSemanticOperation, compileSecCapabilityBinding, compileSecSemanticOperationPlan, issueSecSemanticOperationAttemptContext, type SecOperationDigest } from '../../system-architecture/operation/semantic.ts';
...
import {
  ...
  type ClosedUnmergedProviderObservation,
