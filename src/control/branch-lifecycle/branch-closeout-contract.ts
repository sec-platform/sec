...
export const BRANCH_CLOSEOUT_OPERATION_SCHEMA =
  'sec-branch-closeout-operation-v1' as const;
export const BRANCH_CLOSEOUT_OPERATION_JOURNAL_SCHEMA =
  'sec-branch-closeout-operation-journal-v1' as const;
export const BRANCH_CLOSEOUT_OPERATION_RECEIPT_SCHEMA =
  'sec-branch-closeout-operation-receipt-v1' as const;
export const BRANCH_CLOSEOUT_RECOVERY_ARTIFACT_SCHEMA =
