...
export const ISSUE_DISPOSITION_PLAN_SCHEMA = 'sec-issue-disposition-plan-v1' as const;
export const ISSUE_DISPOSITION_SCHEMA = 'sec-issue-disposition-v1' as const;
export const ISSUE_DISPOSITION_POLICY_REVISION = 'issue-disposition-policy-v1' as const;
...
export function parseIssueDispositionDirective(body: string): IssueDispositionMode {
...
export function parseWorkPackageLocatorForDisposition(body: string): string {
  const lines = boundedText(body, 'pull request body').replaceAll('\r\n', '\n').split('\n');
