...
export const CodexDevelopmentCurrentStateSchema = 'sec-current-state-live-v1' as const;
export const CodexDevelopmentActivePointerSchema = 'sec-active-work-package-pointer-v2' as const;
export const DOCUMENT_CONTROL_PLANE_ENTRYPOINT_PATH =
  'src/control/documentation/document-control-plane.ts' as const;
export const DOCUMENT_CONTROL_PLANE_STATUS_ARGUMENTS = Object.freeze([
...
export type CodexDevelopmentPublishedControlBindingBlockReason =
  | 'ambiguous-binding'
...
export const CodexDevelopmentDocumentControlRecoveryTargetKeys = Object.freeze([
  'freeze-journal',
  'git-index',
  'active-pointer',
  'rolling-plan'
...
export type CodexDevelopmentInitiallyAbsentTupleInvalidReason =
