...
import { SOURCE_PROGRAM_BLOCKING_CANDIDATE_CODES, type SourceProgramFileInput, type SourceProgramModel, type SourceProgramCandidate } from '../source-program-model/contract.ts';
...
import { type GitReadSessionCommand, type GitReadSession } from '../../external-capabilities/git-read/runtime/session.ts';
