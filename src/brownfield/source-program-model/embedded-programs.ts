...
export type SourceProgramEmbeddedProgramLanguage = 'javascript' | 'shell';
export type SourceProgramEmbeddedProgramKind = 'github-script' | 'workflow-run';

export type SourceProgramEmbeddedProgramUnknown = Readonly<{
  code:
