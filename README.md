...
- `npm run platform -- contract ci --json --compact`: emit the compact team CI command contract, including verify gates, quality budgets, diagnostics, and artifact uploads
