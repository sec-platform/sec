...
- `npm run platform -- contract ci --json --compact`: emit the compact team CI command contract, including top-level verify, quality, reference drift, diagnostic, artifact upload commands, and produced artifact paths
