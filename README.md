...
- `explain` writes `project/generated/explain-graph.json`, `project/generated/review-summary.json`, and the local HTML views under `project/generated/views/`; its text output and E2E evidence include artifact upload group and missing reason type counts.
