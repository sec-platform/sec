...
if (args[0] === 'rev-parse' && args[1] === 'HEAD') out(state.baseSha);
if (args[0] === 'rev-parse' && args[1] === 'refs/remotes/origin/main') out(state.liveDefaultSha);
...
if (args[0] === 'ls-remote') {
  ...
  if (requested === 'refs/heads/main') out(state.liveDefaultSha + '\\trefs/heads/main\\n');
