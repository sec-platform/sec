...
import { observeDependencyEntry, sameObservedDependencyDirectory, classifyDependencyEnvironment } from '../../src/toolchain/dependencies/runtime/environment-observation.ts';
