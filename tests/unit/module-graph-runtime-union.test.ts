...
import { assembleSecRepositoryModuleGraph as assemble, resolveSecRepositoryModuleImportCandidates as candidates } from '../../src/brownfield/source-program-model/module-graph.ts';
