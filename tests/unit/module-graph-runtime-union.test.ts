...
import { assembleSecRepositoryModuleGraph as assemble, resolveSecRepositoryModuleImportCandidates as candidates } from '../../src/adapters/repository/source-program-model/module-graph.ts';
