...
import { REVIEW_OBSERVER_READ_ONLY_CAPABILITY_RECEIPT, REVIEW_STABILITY_POLICY, createReviewSnapshotDigest, createReviewStabilityReceipt, renderIndependentReviewTrailer } from '../../src/adapters/verification/platform/review/contract/stability.ts';
...
test('trusted current-base gate authorizes exact candidate facts without executing merge', () => {
  ...
  expect(result.terminalStatusContext).toBe(MergeGateTerminalStatusContext);
