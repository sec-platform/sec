...
import { executeSemanticMutationVerification, planSemanticMutationVerificationCapabilities } from '../../src/compiler/verify/semantic-mutation-verification-adapter.ts';
...
import { assertSemanticMutationVerificationReportInvariant } from '../../src/compiler/verify/semantic-mutation-verification-adapter.ts';
