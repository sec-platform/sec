...
```json
{
  ...
  "items": [
    ...
    },
    {
      ...
      "ownerRef": "github:issue/352",
      "kind": "focused",
      "disposition": "active",
      "priorityClass": "active-critical-path",
      "priorityEvidenceRefs": ["roadmap:r14/controlled-pr-single-writer"],
      "prerequisiteWorkIds": ["issue-346"],
      "orderedAfterWorkIds": [],
      "reproductionOrEvidenceFreshness": "fresh",
      "rootCauseState": "repeat-root-cause",
      "rootCauseRef": "github:issue/352",
      "scopeClosure": "closed",
      "exitCriteriaRef": "github:issue/352#root-design",
