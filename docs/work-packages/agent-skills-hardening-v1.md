...
acceptance:
  ...
  - "Every .agents/skills path resolves to one agent-governance owner and selects the focused agent-skills contract."
...
tests:
  - "bun test tests/contract/agent-skills.test.ts tests/contract/test-impact.test.ts tests/contract/repository-runtime.test.ts --timeout 180000"
  - "bun run typecheck"
  - "bun run docs:doctor"
