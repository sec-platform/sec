...
| authority | verification-governance | [`docs/test-responsibility.md`](test-responsibility.md) | verification.proof-economy、verification.test-lifecycle、verification.test-responsibility | — |
