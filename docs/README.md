...
| authority | change-management | [`docs/change-management.md`](change-management.md) | change.compatibility、change.compensation、change.forward-recovery、change.migration、change.override、change.upgrade |
...
| authority | development-governance | [`docs/development-governance.md`](development-governance.md) | development.agent-operation、development.fact-sources、development.operation-envelope、development.plan-layering、development.resume、development.roles、development.skill、development.work-package |
...
| authority | runtime-distribution | [`docs/runtime-and-distribution.md`](runtime-and-distribution.md) | runtime.distribution、runtime.environment、runtime.host-profile、runtime.layout、runtime.support、runtime.toolchain |
...
| authority | verification-governance | [`docs/verification-governance.md`](verification-governance.md) | verification.aggregate、verification.applicability、verification.claim、verification.environment、verification.evidence、verification.gate、verification.layering、verification.merge-authority、verification.provenance、verification.result |
| authority | workbench-ai | [`docs/workbench-and-ai-operations.md`](workbench-and-ai-operations.md) | ai.bounded-proposal、ai.context-packet、workbench.interaction、workbench.projection、workbench.transport |
| corpus-contract | nexus-corpus | [`docs/corpus/nexus/contract.md`](corpus/nexus/contract.md) | corpus.nexus.conformance |
| proposal | proposal | [`docs/proposals/development-run-kernel.md`](proposals/development-run-kernel.md) | — |
| proposal | proposal | [`docs/proposals/engineering-workspace-domains.md`](proposals/engineering-workspace-domains.md) | — |
...
新增、移动或退役文档必须先修改 registry；未登记 active 文档 fail closed。
