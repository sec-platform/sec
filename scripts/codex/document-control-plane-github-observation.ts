...
export interface GitHubOpenInventoryCountsV1 {
  readonly pullRequests: number;
  readonly issues: number;
}

export interface GitHubReviewThreadConnectionV1 {
...
export interface GitHubReviewThreadPullRequestV1 {
  readonly number: number;
  readonly reviewThreads: GitHubReviewThreadConnectionV1;
}

export interface GitHubObservedReviewThreadPullRequestV1 {
  readonly number: number;
...
export interface GitHubReviewThreadInventoryV1 {
  readonly pullRequests: readonly GitHubObservedReviewThreadPullRequestV1[];
...
export function buildGitHubOpenInventoryCountsArgsV1(repository: string): string[] {
  return graphqlArgs(repository, OPEN_INVENTORY_COUNTS_QUERY, []);
}

export function buildGitHubDefaultBranchRefArgsV1(
  repository: string,
...
export function parseGitHubRepositoryIdentityFromRemoteUrlV1(remoteUrl: string): string | null {
...
export function buildGitHubOpenPullRequestsArgsV1(
  repository: string,
 ...
 */
export function buildGitHubDefaultBranchOpenPullRequestsArgsV1(
  repository: string,
  defaultBranch: string
): string[] {
  repositoryParts(repository);
...
export function buildGitHubOpenIssuesArgsV1(
  repository: string,
  expectedCount: number
): string[] {
  return [
...
export function buildGitHubOpenPullRequestReviewThreadsArgsV1(repository: string): string[] {
  return graphqlArgs(repository, OPEN_PULL_REQUEST_REVIEW_THREADS_QUERY, [], true);
}

export function buildGitHubPullRequestReviewThreadsArgsV1(
  repository: string,
...
export function parseGitHubOpenInventoryCountsV1(source: string): GitHubOpenInventoryCountsV1 {
...
export function parseGitHubDefaultBranchRefV1(source: string): string {
...
export function parseExactGitHubNumberedInventoryV1(
  source: string,
  label: string,
  expectedCount: number
...
interface PartialReviewThreadPullRequestV1 {
  readonly number: number;
  readonly totalCount: number;
  readonly nodes: readonly Readonly<{ isResolved: boolean }>[];
...
export function parseGitHubOpenPullRequestReviewThreadPagesV1(
  source: string,
  expectedPullRequestNumbers: readonly number[]
): GitHubReviewThreadInventoryV1 {
  ...
  const observed = new Map<number, PartialReviewThreadPullRequestV1>();
...
export function parseGitHubPullRequestReviewThreadPagesV1(
  source: string,
  expectedPullRequestNumber: number
): GitHubReviewThreadConnectionV1 {
...
export function replaceIncompleteGitHubReviewThreadsV1(
  inventory: GitHubReviewThreadInventoryV1,
  replacements: ReadonlyMap<number, GitHubReviewThreadConnectionV1>
): readonly GitHubReviewThreadPullRequestV1[] {
