...
const CodexDevelopmentGitHubArtifactMaxBytesV1 = 5_242_880;
const CodexDevelopmentGitHubArtifactSafetyWindowMsV1 = 24 * 60 * 60 * 1_000;
...
function canonicalizeGitHubArtifactMetadataV1(value, options) {
  ...
  if (new Date(expiresAt).getTime() - checkedAtMs < CodexDevelopmentGitHubArtifactSafetyWindowMsV1) {
  ...
  if (value.size_in_bytes > CodexDevelopmentGitHubArtifactMaxBytesV1) {
