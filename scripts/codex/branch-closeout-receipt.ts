...
import { CI_MAIN_HEALTH_POLICY_V1 } from '../../platform/shared/ci-verification-revision.ts';
...
import { SEC_HOSTED_COMMENT_PUBLISHER_POLICY_V1 } from './verification-session-github.ts';
...
export const BRANCH_CLOSEOUT_OPERATION_PUBLICATION_SCHEMA_V1 =
  'sec-branch-closeout-operation-publication-v1' as const;
export const BRANCH_CLOSEOUT_OPERATION_RECEIPT_COMMENT_MARKER =
  '<!-- sec-branch-closeout-operation-receipt-v1 -->' as const;
export const BRANCH_CLOSEOUT_EFFECT_START_PUBLICATION_SCHEMA_V1 =
  'sec-branch-closeout-effect-start-publication-v1' as const;
export const BRANCH_CLOSEOUT_EFFECT_START_COMMENT_MARKER =
  '<!-- sec-branch-closeout-effect-start-v1 -->' as const;
export const BRANCH_CLOSEOUT_MUTATION_PHASE_STEP_NAME_V1 =
  'Close out exact integrated branch' as const;
export const HOSTED_WORKFLOW_COMMENT_PROVENANCE_SCHEMA_V1 =
  'sec-hosted-workflow-comment-provenance-v1' as const;

export interface HostedWorkflowCommentProvenanceV1 {
  schema: typeof HOSTED_WORKFLOW_COMMENT_PROVENANCE_SCHEMA_V1;
  repositoryId: string;
...
export interface BranchCloseoutOperationPublicationV1 {
  schema: typeof BRANCH_CLOSEOUT_OPERATION_PUBLICATION_SCHEMA_V1;
  closeoutOperationId: `sha256:${string}`;
  binding: BranchCloseoutOperationBindingV1;
  effectStart: BranchCloseoutEffectStartReferenceV1;
  receipt: BranchCloseoutStablePublishedReceiptV1;
  provenance: HostedWorkflowCommentProvenanceV1;
  publicationDigest: `sha256:${string}`;
}

export interface BranchCloseoutEffectStartReferenceV1 {
  effectStartId: `sha256:${string}`;
  publicationDigest: `sha256:${string}`;
  commentId: number;
}

export interface BranchCloseoutEffectStartPublicationV1 {
  schema: typeof BRANCH_CLOSEOUT_EFFECT_START_PUBLICATION_SCHEMA_V1;
  effectStartId: `sha256:${string}`;
  closeoutOperationId: `sha256:${string}`;
  binding: BranchCloseoutOperationBindingV1;
  ...
  phase: {
    ...
    stepName: typeof BRANCH_CLOSEOUT_MUTATION_PHASE_STEP_NAME_V1;
    stepNumber: number;
    workflowSha: string;
  };
  provenance: HostedWorkflowCommentProvenanceV1;
...
export interface BranchCloseoutStablePublishedReceiptV1 {
  repository: string;
  ...
  authorization: BranchPublishedCloseoutReceiptV1['authorization'];
  readback: BranchPublishedCloseoutReceiptV1['readback'];
...
function hostedWorkflowCommentProvenancePayload(input: Omit<
  HostedWorkflowCommentProvenanceV1,
  'schema' | 'provenanceDigest'
>): Omit<HostedWorkflowCommentProvenanceV1, 'provenanceDigest'> {
  return { schema: HOSTED_WORKFLOW_COMMENT_PROVENANCE_SCHEMA_V1, ...input };
}

export function createHostedWorkflowCommentProvenanceV1(input: Omit<
  HostedWorkflowCommentProvenanceV1,
  'schema' | 'provenanceDigest'
>): HostedWorkflowCommentProvenanceV1 {
  ...
  if (input.app.id !== CI_MAIN_HEALTH_POLICY_V1.app.id
    || input.app.nodeId !== CI_MAIN_HEALTH_POLICY_V1.app.nodeId
    || input.app.slug !== CI_MAIN_HEALTH_POLICY_V1.app.slug) {
...
export function parseHostedWorkflowCommentProvenanceV1(
  value: unknown
): HostedWorkflowCommentProvenanceV1 {
  ...
  const provenance = createHostedWorkflowCommentProvenanceV1({
...
function effectStartPublicationPayload(input: Omit<
  BranchCloseoutEffectStartPublicationV1,
  'schema' | 'effectStartId' | 'publicationDigest'
>): Omit<BranchCloseoutEffectStartPublicationV1, 'publicationDigest'> {
  const effectStartId = branchCloseoutEffectStartId(input.closeoutOperationId);
  return { schema: BRANCH_CLOSEOUT_EFFECT_START_PUBLICATION_SCHEMA_V1,
    effectStartId, ...input };
}

export function createBranchCloseoutEffectStartPublicationV1(input: {
  binding: BranchCloseoutOperationBindingV1;
  authorizationPublication: BranchCloseoutEffectStartPublicationV1['authorizationPublication'];
  recoveryArtifact: BranchCloseoutEffectStartPublicationV1['recoveryArtifact'];
  phase: BranchCloseoutEffectStartPublicationV1['phase'];
  provenance: HostedWorkflowCommentProvenanceV1;
}): BranchCloseoutEffectStartPublicationV1 {
...
export function parseBranchCloseoutEffectStartPublicationV1(
  value: unknown
): BranchCloseoutEffectStartPublicationV1 {
  ...
  if (value.schema !== BRANCH_CLOSEOUT_EFFECT_START_PUBLICATION_SCHEMA_V1) {
  ...
  const binding = value.binding as BranchCloseoutOperationBindingV1;
  assertBranchCloseoutOperationBindingV1(binding);
  const rebuilt = createBranchCloseoutEffectStartPublicationV1({ binding,
    authorizationPublication: {
    ...
    phase: {
      ...
      stepName: value.phase.stepName as typeof BRANCH_CLOSEOUT_MUTATION_PHASE_STEP_NAME_V1,
      stepNumber: value.phase.stepNumber as number,
      workflowSha: value.phase.workflowSha as string
    },
    provenance: value.provenance as HostedWorkflowCommentProvenanceV1
  });
...
export function renderBranchCloseoutEffectStartPublicationComment(
  ...
  const validated = parseBranchCloseoutEffectStartPublicationV1(publication);
  return `${EFFECT_START_COMMENT_JSON_PREFIX}${encodeVerificationActionDataV2(validated)}${COMMENT_JSON_SUFFIX}`;
}

export function parseBranchCloseoutEffectStartPublicationComment(
  source: string
): BranchCloseoutEffectStartPublicationV1 | null {
  ...
  const publication = parseBranchCloseoutEffectStartPublicationV1(JSON.parse(json));
...
function parseBranchCloseoutEffectStartReferenceV1(
  value: unknown
): BranchCloseoutEffectStartReferenceV1 {
...
export function listIssueComments(
  ...
  if (result.status !== 0) {
    return { comments: null, detail: decodeBranchLifecycleChildErrorV1(result) };
  }
  try {
    return {
      comments: issueCommentRecords(decodeBranchLifecycleChildStdoutV1(result)),
      detail: null
    };
  } catch (error) {
    return {
...
export function hostedPublisherMatches(comment: IssueCommentRecord): boolean {
  const bot = SEC_HOSTED_COMMENT_PUBLISHER_POLICY_V1.bot;
  ...
  return comment.app !== null && (comment.app.id === SEC_HOSTED_COMMENT_PUBLISHER_POLICY_V1.app.id
    && comment.app.nodeId === SEC_HOSTED_COMMENT_PUBLISHER_POLICY_V1.app.nodeId
    && comment.app.slug === SEC_HOSTED_COMMENT_PUBLISHER_POLICY_V1.app.slug);
}
...
function jsonApi(repositoryRoot: string, endpoint: string, label: string): Record<string, unknown> {
  ...
  const value: unknown = JSON.parse(decodeBranchLifecycleChildStdoutV1(result));
  assertRecord(value, label);
  return value;
}
...
function effectStartPublicationsInComments(
  ...
  for (const comment of comments) {
    ...
    let publication: BranchCloseoutEffectStartPublicationV1;
    try {
...
export function assertBranchCloseoutEffectStartMatchesV1(input: {
  publication: BranchCloseoutEffectStartPublicationV1;
  binding: BranchCloseoutOperationBindingV1;
  authorizationPublication: BranchCloseoutEffectStartPublicationV1['authorizationPublication'];
  recoveryArtifact: BranchCloseoutEffectStartPublicationV1['recoveryArtifact'];
}): void {
  const publication = parseBranchCloseoutEffectStartPublicationV1(input.publication);
  assertBranchCloseoutOperationBindingV1(input.binding);
  if (encodeVerificationActionDataV2(publication.binding)
    !== encodeVerificationActionDataV2(input.binding)) {
  ...
  if (encodeVerificationActionDataV2(publication.authorizationPublication)
      !== encodeVerificationActionDataV2(expectedAuthorization)
    || encodeVerificationActionDataV2(publication.recoveryArtifact)
      !== encodeVerificationActionDataV2(expectedRecovery)) {
    throw new Error('Closeout effect start authority or recovery artifact differs from the exact merged operation.');
  }
}

export function observeBranchCloseoutEffectStartPublicationV1(
  repositoryRoot: string,
...
function operationPublicationPayload(input: {
  ...
  receipt: BranchCloseoutStablePublishedReceiptV1;
  provenance: HostedWorkflowCommentProvenanceV1;
}): Omit<BranchCloseoutOperationPublicationV1, 'publicationDigest'> {
  return {
    schema: BRANCH_CLOSEOUT_OPERATION_PUBLICATION_SCHEMA_V1,
...
): BranchCloseoutStablePublishedReceiptV1 {
...
function parseStablePublishedReceipt(value: unknown): BranchCloseoutStablePublishedReceiptV1 {
  ...
  const receipt: BranchCloseoutStablePublishedReceiptV1 = {
    repository,
    pullRequest,
    branch: value.branch,
    preparedHeadSha: value.preparedHeadSha,
...
export function createBranchCloseoutOperationPublicationV1(
  operationReceipt: BranchCloseoutOperationReceiptV1,
  provenanceInput: HostedWorkflowCommentProvenanceV1,
  effectStartInput: {
    publication: BranchCloseoutEffectStartPublicationV1;
    commentId: number;
  }
): BranchCloseoutOperationPublicationV1 {
  const validated = parseBranchCloseoutOperationReceiptV1(
    `${JSON.stringify(operationReceipt, null, 2)}\n`
  );
  const effectStartPublication = parseBranchCloseoutEffectStartPublicationV1(
    effectStartInput.publication);
  if (encodeVerificationActionDataV2(effectStartPublication.binding)
    !== encodeVerificationActionDataV2(validated.binding)) {
    throw new Error('Terminal closeout publication effect start belongs to another operation.');
  }
  const effectStart = parseBranchCloseoutEffectStartReferenceV1({
  ...
  const payload = operationPublicationPayload({
    ...
    provenance: parseHostedWorkflowCommentProvenanceV1(provenanceInput)
  });
  return { ...payload, publicationDigest: branchLifecycleDigest(payload) };
}

export function parseBranchCloseoutOperationPublicationV1(
  value: unknown
): BranchCloseoutOperationPublicationV1 {
  ...
  if (value.schema !== BRANCH_CLOSEOUT_OPERATION_PUBLICATION_SCHEMA_V1) {
  ...
  const effectStart = parseBranchCloseoutEffectStartReferenceV1(value.effectStart);
  ...
  const provenance = parseHostedWorkflowCommentProvenanceV1(value.provenance);
...
export function renderBranchCloseoutOperationPublicationComment(
  ...
  const validated = parseBranchCloseoutOperationPublicationV1(publication);
  return `${OPERATION_COMMENT_JSON_PREFIX}${encodeVerificationActionDataV2(validated)}${COMMENT_JSON_SUFFIX}`;
}

export function parseBranchCloseoutOperationPublicationComment(
  source: string
): BranchCloseoutOperationPublicationV1 | null {
  ...
  const publication = parseBranchCloseoutOperationPublicationV1(JSON.parse(json));
...
function operationPublicationInComments(
  ...
  const sameOperation: Array<{ comment: IssueCommentRecord; publication: BranchCloseoutOperationPublicationV1 }> = [];
  for (const comment of comments) {
...
function assertEffectStartReferenceInComments(
  ...
  repository: string,
  comments: readonly IssueCommentRecord[],
  terminal: BranchCloseoutOperationPublicationV1
): void {
  ...
  if (start!.commentId !== terminal.effectStart.commentId
    ...
    || encodeVerificationActionDataV2(start!.publication.binding)
...
export function observeBranchCloseoutOperationPublicationV1(
  repositoryRoot: string,
  input: { repository: string; pullRequestNumber: number; closeoutOperationId: `sha256:${string}` }
): Readonly<{ publication: BranchCloseoutOperationPublicationV1; commentId: number }> | null {
  const endpoint = `/repos/${input.repository}/issues/${input.pullRequestNumber}/comments`;
  const inventory = listIssueComments(repositoryRoot, endpoint);
  if (inventory.comments === null) {
    throw new Error(`Closeout publication inventory failed: ${inventory.detail}`);
  }
  const matching: Array<{ publication: BranchCloseoutOperationPublicationV1; commentId: number }> = [];
  for (const comment of inventory.comments) {
    ...
    let publication: BranchCloseoutOperationPublicationV1;
    try {
      const parsed = parseBranchCloseoutOperationPublicationComment(comment.body);
