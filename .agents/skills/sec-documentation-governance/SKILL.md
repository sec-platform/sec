...
## 权限与路径
- 只修改manifest声明的Markdown/文档脚本；archive/evidence不升格为authority。

## 允许工具与操作
- Markdown分类器、docs doctor、link/frontmatter/H1检查、Skill coverage。

## 前置门禁
- canonical owner与文档生命周期已确定。
...
## 完成证据
- 全Markdown分类、active coverage、docs零error、pointer binding。

## 停止与恢复
- 全部Markdown分类且活动启发式表面有Skill owner，docs零error。
- 未知active文档或孤立启发式立即fail closed并补owner/Skill。
