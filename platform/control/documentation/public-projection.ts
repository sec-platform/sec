...
} from '../../shared/documentation-authority-contract.ts';

export const PUBLIC_DOCUMENTATION_PROJECTION_SCHEMA_V1 =
...
const manifestSchema = z.object({
  schema: z.literal(PUBLIC_DOCUMENTATION_PROJECTION_SCHEMA_V1),
...
export type PublicDocumentationProjectionV1 = Readonly<{
  readonly schema: typeof PUBLIC_DOCUMENTATION_PROJECTION_SCHEMA_V1;
...
export async function readPublicDocumentationProjectionV1(
...
): Promise<PublicDocumentationProjectionV1> {
  ...
  return Object.freeze({
    schema: PUBLIC_DOCUMENTATION_PROJECTION_SCHEMA_V1,
