...
const loadCompilerFacade = memoizedModule(() => import('../compiler/index.ts'));
...
export const loadDependencyEnvironmentDomain = memoizedModule(() => import('../shared/dependency-environment.ts'));
export const loadProjectOverviewDomain = memoizedModule(() => import('../shared/project-overview.ts'));
export const loadReferenceCheckDomain = memoizedModule(() => import('../shared/reference-check.ts'));
export const loadTestBudgetDomain = memoizedModule(() => import('../shared/test-budget-contract.ts'));
...
const loadTextByteCensus = memoizedModule(() => import('../../tooling/sec-dev/text/text-byte-census.ts'));
const loadWorktreeSettlement = memoizedModule(() => import('../../tooling/sec-dev/workspace/worktree-settlement.ts'));

export const buildCiArtifactManifest = lazyFunction(loadCompilerFacade, 'buildCiArtifactManifest');
export const loadManifestById = lazyFunction(loadCompilerFacade, 'loadManifestById');
export const loadWorkspacePlan = lazyFunction(loadCompilerFacade, 'loadWorkspacePlan');
