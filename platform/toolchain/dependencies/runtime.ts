...
export type {
  ...
  RuntimeDependencyTargetIdentityV1,
  RuntimeDepsStamp,
...
export const parseCompilerDependencyLocatorRetirementPlanV1 =
  runtime.parseCompilerDependencyLocatorRetirementPlanV1;
export const compilerDependencyLocatorWorktreeRetirementProviderV1 =
  runtime.compilerDependencyLocatorWorktreeRetirementProviderV1;
export const readRuntimeDepsStamp = runtime.readRuntimeDepsStamp;
export const writeRuntimeDepsStamp = runtime.writeRuntimeDepsStamp;

export async function disposeCanonicalSharedDependencies(
  options: RuntimeDependencyInstallOptions = {},
  outcome = 'maintainer-clean-requested'
): Promise<boolean> {
  return runtime.disposeCanonicalSharedDependencies(dependencyInstallOptions(options), outcome);
}
