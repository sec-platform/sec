...
function usage(): never {
  console.error('Usage: bun ./platform/dev-runner.ts <typecheck|test|test:affected|test:fast|test:slow|contract-freeze|imports:check|imports:organize|clean-test-workspaces> [args...]');
  process.exit(1);
}
