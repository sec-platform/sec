...
export const WINDOWS_APPCONTAINER_LAYOUT_V1 = Object.freeze({
  runtimeRelativePath: RUNTIME_DIRECTORY_NAME,
  hostBunConfigRelativePath: HOST_BUN_CONFIG_RELATIVE_ROOT,
  recoveryOwner: Object.freeze({
    formatVersion: RECOVERY_OWNER_FORMAT_VERSION,
    fileName: RECOVERY_OWNER_FILE_NAME,
    pendingFileName: RECOVERY_OWNER_PENDING_FILE_NAME
  }),
  provisionalOwner: Object.freeze({
    formatVersion: PROVISIONAL_OWNER_FORMAT_VERSION,
    fileName: PROVISIONAL_OWNER_FILE_NAME,
    pendingFileName: PROVISIONAL_OWNER_PENDING_FILE_NAME
  }),
  nativeResultFileName: NATIVE_RESULT_FILE_NAME
} as const);
