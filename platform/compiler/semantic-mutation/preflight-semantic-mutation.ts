...
export function preflightSemanticMutation(
  input: SemanticMutationPreflightInputV2
): SemanticMutationPreflightV2 {
...
export function semanticMutationPreflightRevision(
  input: Parameters<typeof preflightRevision>[0]
): string {
  return preflightRevision(input);
}
