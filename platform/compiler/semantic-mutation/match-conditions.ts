...
function factForSelector(
  ...
  selector: SemanticFactSelectorV1
...
export function mergeSemanticMutationConditions(
  ...collections: readonly (readonly SemanticMutationConditionV1[])[]
): SemanticMutationConditionV1[] {
  const byId = new Map<string, SemanticMutationConditionV1>();
...
function conditionMatches(
  snapshot: ValidatedEngineeringIRSnapshot,
  condition: SemanticMutationConditionV1
...
export function matchSemanticMutationConditions(
  snapshot: ValidatedEngineeringIRSnapshot,
  conditions: readonly SemanticMutationConditionV1[],
  options: {
