...
]) as readonly VerificationRequirementV1[];

export const SEMANTIC_MUTATION_OPERATION_DESCRIPTORS = Object.freeze({
  'add-state-transition': Object.freeze({
    kind: 'add-state-transition',
    riskFloor: 'high',
    minimumVerification: ADD_STATE_TRANSITION_MINIMUM_VERIFICATION,
...
export interface ValidatedAddStateTransitionOperation {
  readonly operation: AddStateTransitionOperationV1;
...
export function validateSemanticMutationOperations(
  ...
  operations: readonly AddStateTransitionOperationV1[],
  authorization: SemanticMutationAuthorizationContextV2
): { readonly operations: readonly ValidatedAddStateTransitionOperation[]; readonly diagnostics: readonly SemanticMutationDiagnosticV2[] } {
