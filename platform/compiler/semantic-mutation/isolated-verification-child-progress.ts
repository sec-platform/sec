...
export const SEMANTIC_MUTATION_ISOLATED_BOOTSTRAP_RELATIVE_PATH =
  '.isolated-compiler/platform/orchestrator/semantic-mutation-isolated-verification-bootstrap.mjs' as const;
...
export interface SemanticMutationIsolatedBundledLoaderBindingV1 {
...
function assertBundledLoaderBinding(
  binding: SemanticMutationIsolatedBundledLoaderBindingV1
): void {
