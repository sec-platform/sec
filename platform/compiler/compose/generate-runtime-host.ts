...
function renderTicketRuntimeAcceptanceTest(): string {
...
function scaffoldEntries(lock: LockFile): Array<{ relativePath: string; source: string }> {
  ...
  if (ticketEnabled) {
    entries.push(
      { relativePath: 'app/tickets/page.tsx', source: renderTicketsPage() },
      { relativePath: 'app/api/tickets/route.ts', source: renderTicketsRoute() },
      { relativePath: 'app/api/tickets/[ticketId]/status/route.ts', source: renderTicketStatusRoute() },
      ...
      { relativePath: 'tests/runtime/unit/ticket-runtime.test.ts', source: renderTicketRuntimeUnitTest() },
      { relativePath: 'tests/runtime/acceptance/ticket-flow.spec.ts', source: renderTicketRuntimeAcceptanceTest() }
    );
  }
