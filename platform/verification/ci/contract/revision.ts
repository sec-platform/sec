...
} from '../../../shared/sec-linux-verification-environment.ts';
import { VERIFICATION_SESSION_SCHEMA_V2 } from '../../session/index.ts';
...
export const CI_VERIFICATION_SESSION_ARTIFACT_PREFIX = VERIFICATION_SESSION_SCHEMA_V2;
