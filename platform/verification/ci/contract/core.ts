...
} from '../../ci-artifacts/index.ts';
import type { CiArtifactKind } from '../../ci-artifacts/index.ts';
import { CI_VERIFICATION_EXECUTION_MODEL } from './plan.ts';
import {
...
import { CONTRACT_FORMAT_VERSION, CONTRACT_STATUS_ACTIVE } from '../../../shared/constants.ts';
import { platformCommand } from '../../../cli/contract.ts';
import { slowTestSuiteIds } from '../../test-impact/index.ts';
...
export type CiContract = {
  ...
  verificationContractRevision: typeof CI_VERIFICATION_COMPOSITION_CONTRACT_REVISION;
...
export function buildCiContract(): CiContract {
  ...
  return {
    ...
    verificationContractRevision: CI_VERIFICATION_COMPOSITION_CONTRACT_REVISION,
