import { DOCUMENT_CONTROL_PLANE_LIFECYCLE_TEST_FILE } from '../index.ts';
...
export const governanceTestOwnershipDeclarations: TestOwnershipDeclaration[] = [
  ...
  },
  {
    ...
    sourceFiles: [
      'platform/control/work-selection/contract.ts',
      'platform/control/work-selection/live-contract.ts',
  ...
  {
    owner: 'local-continuation',
    identity: { kind: 'contract', id: 'local-continuation' },
    sourceFiles: [
      'platform/shared/local-continuation-checkpoint.ts',
      'scripts/codex/local-continuation.ts'
    ],
    supplementalFast: [
  ...
  {
    owner: 'public-documentation-projection',
    identity: { kind: 'contract', id: 'public-documentation-projection' },
    sourceFiles: [
      'docs/authority.json',
      'platform/control/documentation/public-projection.ts',
      'platform/shared/documentation-authority-contract.ts',
      'public-docs/manifest.json'
    ],
    sourcePrefixes: ['public-docs/'],
    supplementalFast: [
