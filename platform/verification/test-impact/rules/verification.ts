import type { SecOperationVerificationObligationV1 } from '../../../shared/operation-demand-contract.ts';
import {
...
export const verificationPhysicalUniverseTestSentinelsV1 = Object.freeze([
  Object.freeze({
    ...
    fast: Object.freeze(['tests/contract/repository-module-architecture.test.ts'])
  }),
  Object.freeze({
...
export const verificationTestOwnershipDeclarations: TestOwnershipDeclaration[] = [
  ...
  },
  {
    ...
    sourceFiles: ['platform/workspace/state/write-lease.ts'],
  ...
  },
  {
    ...
    sourceFiles: [
      ...
      'platform/verification/acceptance/index.ts',
