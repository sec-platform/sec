...
export const TCB_REVIEWED_EXTERNAL_IMPORTS = new Set([
  ...
  'platform/runtime-physical/runtime/observed-process.ts -> bun:ffi',
  'platform/runtime-physical/runtime/physical-no-follow.ts -> bun:ffi',
  'platform/runtime-physical/runtime/process.ts -> node:string_decoder',
  'platform/shared/sec-linux-verification-environment.ts -> zod',
  'platform/external-capabilities/windows-control-cli/contract/environment.ts -> zod',
  'platform/runtime-physical/runtime/windows-host-filesystem-authority.ts -> bun:ffi',
]);
...
export const TCB_REVIEWED_PROCESS_DISPATCHERS = new Set([
  'platform/dev-runner.ts::function-declaration:handoffDevRunnerToFreshProcessV1::Bun.spawn#1',
  ...
  'platform/runtime-physical/runtime/observed-process.ts::function-declaration:defaultSpawnChild::spawn#1',
  'platform/runtime-physical/runtime/process.ts::function-declaration:runCommandCapture::spawn#1',
  'platform/runtime-physical/runtime/process.ts::function-declaration:terminateCommandProcessTree::spawn#1',
