...
export type { ReviewArtifactMissingEntry, ReviewArtifactSummary, ReviewArtifactUploadGroup } from './review-artifact.ts';

export type { ReviewUpgradeDiagnosticsSummary, ReviewUpgradeMigrationOperationSummary, ReviewUpgradeMigrationSummary, ReviewUpgradePreflightSummary, ReviewUpgradeSummary, ReviewUpgradeVerificationSummary } from './review-upgrade.ts';
...
export interface ReviewSummary {
  ...
  upgradeSummary?: import('./review-upgrade.ts').ReviewUpgradeSummary;
