...
export function computeTcbClosureLock(
  ...
  repositoryRoot: string = compilerRoot
): TcbClosureLock {
  ...
  for (const module of modules) {
    const absolutePath = path.join(repositoryRoot, ...module.split('/'));
    let bytes: Uint8Array;
    try {
      bytes = readFileSync(absolutePath);
    } catch (error) {
      throw new Error(
        `TCB closure module is missing or unreadable: ${module}. ${error instanceof Error ? error.message : String(error)}`
      );
    }
...
export function verifyTcbClosureLock(input: TcbClosureLockInput): TcbClosureLockVerification {
  ...
  try {
    actual = computeTcbClosureLock(input);
  } catch (error) {
    return {
      status: 'failed',
      failures: [
...
function parseTcbClosureLockValueV2(value: unknown, allowLegacyRevision: boolean): TcbClosureLock {
  ...
  if (
    value.trustRevision !== derivedTrustRevision
    && !(allowLegacyRevision && /^[0-9a-f]{40}$/u.test(value.trustRevision))
...
function renderTcbClosureGeneratedRegionInternalV2(
  lock: TcbClosureLock,
  generatedAt: string,
  allowLegacyRevision: boolean
): string {
  const parsedLock = parseTcbClosureLockValueV2(lock, allowLegacyRevision);
  assertCanonicalGeneratedAtV2(generatedAt);
  return [
...
export function renderTcbClosureGeneratedRegionV2(
  ...
  return renderTcbClosureGeneratedRegionInternalV2(lock, generatedAt, false);
}
...
export function parseTcbClosureGeneratedRegionV2(source: string): TcbClosureGeneratedRegionV2 {
  ...
  const lock = parseTcbClosureLockValueV2(lockValue, true);
  ...
  if (rawRegion !== renderTcbClosureGeneratedRegionInternalV2(lock, generatedAt, true)) {
...
export function planTcbClosureLockSourceV2(input: {
  ...
  const nextLock = parseTcbClosureLockValueV2(input.nextLock, false);
...
export function generateTcbClosureLockV2(): TcbClosureLock {
  const closure = trustedRuntimeClosure();
  return computeTcbClosureLock(closure);
}

// Compatibility entrypoint for the immediately preceding trusted-base workflow.
export function generateTcbClosureLockForRevision(trustedBaseRevision: string): TcbClosureLock {
  if (!/^[0-9a-f]{40}$/u.test(trustedBaseRevision)) {
    throw new Error('Trusted bootstrap base revision must be one exact Git SHA.');
  }
  return generateTcbClosureLockV2();
}
...
export const TCB_CLOSURE_TRUST_REVISION = "sha256:076f20f0447ede54db664464988fb94e0531377f79acd10d6114a9614d479fd7";

// Generated from the exact live causal closure. Do not hand-edit this marked region.
export const TCB_CLOSURE_LOCK: TcbClosureLock = {
  "schema": "sec-tcb-closure-lock-v2",
  "trustRevision": "sha256:076f20f0447ede54db664464988fb94e0531377f79acd10d6114a9614d479fd7",
  "moduleCount": 93,
  "modules": [
  ...
  "moduleBlobs": {
    ...
    "scripts/codex/verification-action-github-provider.ts": "917827c02c57bdccbfc9ce6e34ee8e127f9dc7b4",
    ...
    "scripts/codex/verification-session.ts": "6ea9785660f80b970dcc9c1228a9a4d4b4848b9a",
  ...
  "moduleContentDigests": {
    ...
    "scripts/codex/verification-action-github-provider.ts": "sha256:7c20bd53ef7978bba58fde4416741a0842a01154f044efdfc37c0b152681f7c5",
    ...
    "scripts/codex/verification-session.ts": "sha256:98e4ac946ecfebd486cb77cef363bfb1a2b55af90b9a1bd5e62f3c1d8b96db8f",
  ...
  "closureDigest": "sha256:a123af7751d55b47e68cfd36872f3afcd415e0e91017aa89ff183842d718c733"
};

export const TCB_CLOSURE_LOCK_RECEIPT = createTcbClosureLockReceiptV2(
  TCB_CLOSURE_LOCK,
  "2026-08-09T22:42:17.991Z"
);
// </sec-tcb-closure-lock-generated-v2>
