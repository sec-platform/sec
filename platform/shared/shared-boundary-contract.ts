...
/**
 * REM-004 first-slice classification of every file physically present under
 * `platform/shared/**`. This registry owns placement classification only; it
 * does not acquire the domain semantics of any listed file.
 *
...
export const SHARED_CROSS_DOMAIN_CONTRACT_PATHS = [
  ...
  'legacy-composition-baseline-types.ts',
  'lock-types.ts',
