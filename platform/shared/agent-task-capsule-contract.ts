...
export interface SecAgentOperationScopeProposalV1 {
...
export interface SecTaskCapsulePlanningContextV1 {
  ...
  readonly workPackageProposalDigest: SecDigestV1;
  readonly workPackageProjectionId: SecDigestV1;
  readonly scopeGrantId: null;
  readonly ownerFacts: readonly SecAgentOwnerFactV1[];
  readonly scopeProposal: SecAgentOperationScopeProposalV1;
...
export interface SecTaskCapsuleInputV1 {
  ...
  readonly ref: string;
  readonly planningContext: SecTaskCapsulePlanningContextV1;
}
 ...
 */
export interface SecTaskCapsuleV1 {
...
function parseScopeProposal(value: unknown): SecAgentOperationScopeProposalV1 {
...
function parsePlanningContext(value: unknown): SecTaskCapsulePlanningContextV1 {
...
export function compileSecTaskCapsuleV1(value: unknown): SecTaskCapsuleV1 {
  ...
  return deepFreeze({
    ...withoutDigest,
    digest: sha256(withoutDigest) as SecDigestV1
  });
}

export function parseSecTaskCapsuleV1(value: unknown): SecTaskCapsuleV1 {
  ...
  const compiled = compileSecTaskCapsuleV1({
