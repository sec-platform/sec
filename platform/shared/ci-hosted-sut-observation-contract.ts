import { canonicalEquals, sha256 as canonicalSha256 } from './canonical-primitives.ts';
import {
...
import type { VerificationActionProviderOriginV2 } from './verification-action-provider-contract.ts';
import {
