...
import { compareCodeUnits } from '../../foundation/canonical.ts';
...
import { TOOL_EVIDENCE_REPORT_KINDS, type ToolEvidenceReport, type ToolEvidenceReportKind } from '../../shared/tool-evidence-contract.ts';
import type { AcceptanceCoverageReport } from '../../semantic/acceptance/index.ts';
import type { CiArtifactManifest } from '../../verification/ci-artifacts/index.ts';
import type { ExplainGraph } from '../../semantic/projection/index.ts';
import type { LockFile } from '../../compiler/contract.ts';
import type { PolicyReport } from '../../policies/index.ts';
import type { ProvenanceFile } from '../../semantic/provenance/index.ts';
import type {
  ReviewRegressionRisk,
  ReviewSummary
} from '../../verification/review/index.ts';
import type { VerificationReport } from '../../verification/index.ts';
