...
import { readOptionalRetainedOrdinaryFileV1 } from '../../runtime-physical/index.ts';

function readProjectFileBytes(absolutePath: string): Uint8Array | undefined {
  return readOptionalRetainedOrdinaryFileV1(absolutePath, 'Project integrity hash') ?? undefined;
}
